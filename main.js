...
const tape_pointer = new PIXI.Text('*');

// Utility function to create a button
function createButton(x, y, width, height, label, onClick) {
    const button = new PIXI.Graphics();
    button.beginFill(0x333333); // Button color
    button.drawRoundedRect(0, 0, width, height, 10); // Rounded rectangle button
    button.endFill();
    button.x = x;
    button.y = y;
...
// Example usage
var startBtn = createButton(200, 150, 100, 50, "Start", startPalindromeProgram);
app.stage.addChild(startBtn);

var restartBtn = createButton(200, 150, 100, 50, "Restart", restartPalindromeProgram);
app.stage.addChild(restartBtn);
restartBtn.visible = false;

var stopBtn = createButton(400, 150, 100, 50, "Stop", stopProgram);
app.stage.addChild(stopBtn);

var resumeBtn = createButton(600, 150, 100, 50, "Resume", resumeProgram);
app.stage.addChild(resumeBtn);

// Remaining functions for button actions (startPalindromeProgram, restartPalindromeProgram, etc.)
// should be defined as they were in your original code.
app.stage.addChild(resumeBtn);
...
// Add title
const title = new PIXI.Text('Turing Machine web app', {
    fill: '#272d37',
    fontFamily: 'Roboto',
    fontSize: 20,
    align: 'center',
